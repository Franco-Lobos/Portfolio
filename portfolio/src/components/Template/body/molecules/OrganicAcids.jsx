...
export class OrganicAcids{
    ...
    setZoom(molecule){
        ...
        this.drawSet.carbon1.position = molecule.position.copy().sub(this.drawSet.bondDif.cc.x/2,this.drawSet.bondDif.cc.y/2)
        ...
        this.drawSet.carbon4.position = this.drawSet.carbon3.position.copy().add(this.drawSet.bondDif.cc.x,-this.drawSet.bondDif.cc.y)
        ...
        this.drawSet.oxigen22.position = this.drawSet.carbon2.position.copy().add(-this.drawSet.bondDif.co.x,-this.drawSet.bondDif.co.y)
        ...
        this.drawSet.oxigen42.position = this.drawSet.carbon4.position.copy().add(this.drawSet.bondDif.co.x,this.drawSet.bondDif.co.y)
    ...
    draw(p5,molecule,colors){
        ...
        if(molecule.focused){
            ...
            // // carbon 3 - carbon 4
            molecule.drawP1P1(p5,this.drawSet.carbon3, this.drawSet.carbon4, molecule.bond.cc, 2/6);
            molecule.drawP1P1(p5,this.drawSet.carbon4, this.drawSet.carbon3, molecule.bond.cc, 2/6);
        
            // // carbon 2 - oxigen 22
            molecule.drawP1P1(p5,this.drawSet.oxigen22, this.drawSet.carbon2, molecule.bond.co, 2/6);
            molecule.drawP1P1(p5,this.drawSet.carbon2, this.drawSet.oxigen22, molecule.bond.co, 2/6);

            // // carbon 4 - oxigen 42
            molecule.drawP1P1(p5,this.drawSet.oxigen42, this.drawSet.carbon4, molecule.bond.co, 2/6);
            molecule.drawP1P1(p5,this.drawSet.carbon4, this.drawSet.oxigen42, molecule.bond.co, 2/6);
